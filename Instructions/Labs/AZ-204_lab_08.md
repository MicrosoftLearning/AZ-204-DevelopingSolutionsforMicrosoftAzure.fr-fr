...
1.  Dans la fenêtre de navigateur qui s’ouvre, accédez au portail Azure ([portal.azure.com](https://portal.azure.com)), puis connectez-vous à l’aide du compte que vous allez utiliser pour ce labo.
    ...
    > **Remarque** : si vous vous connectez au portail Azure la première fois, une visite guidée du portail vous sera proposée. Sélectionnez **Prise en main** pour ignorer la visite guidée et commencer à utiliser le portail.
