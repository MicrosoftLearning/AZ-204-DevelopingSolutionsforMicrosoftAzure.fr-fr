...
1.  Dans le volet **Créer un application web**, sous l’onglet **Options de base**, effectuez les actions suivantes :
    ...
    | Section **Plan tarifaire** | Sélectionnez **Modifier la taille**. Dans le volet **Sélecteur de spécifications**, sélectionnez **Afficher d’autres options**, **S1**, puis **Appliquer** |
