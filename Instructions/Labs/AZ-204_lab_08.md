...
1. Dans le volet **Créer un application web**, sous l’onglet **Options de base**, effectuez les actions suivantes :
    ...
    | Section **Plan tarifaire** | Sélectionnez **Explorer les plans tarifaires**, dans la page **Sélectionner un plan tarifaire App Service**, sélectionnez **S1**, puis **Sélectionner**. |
...
1. Dans la section **Réponse HTTP**, effectuez les actions suivantes:
    ...
    1. Si une fenêtre contextuelle s’ouvre pour confirmer l’activation du traçage, sélectionnez le bouton **Activer le traçage pendant une heure** 
