...
## Assurez-vous que l’horloge de votre environnement de labo local est correctement réglée (sans retard par rapport à vote fuseau horaire)
...
Dans ce labo, vous allez inscrire une application dans Azure AD, ajouter un utilisateur, puis tester l’accès de l’utilisateur à l’application pour vérifier qu’Azure AD peut le sécuriser. Vous utiliserez également l’outil Afficheur Graph pour créer et tester des demandes sur l’API Graph pour un compte d’utilisateur Azure AD.
