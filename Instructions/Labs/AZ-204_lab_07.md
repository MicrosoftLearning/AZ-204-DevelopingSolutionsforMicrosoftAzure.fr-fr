...
1. Dans le volet **Créer un secret**, effectuez les actions suivantes, puis sélectionnez **Créer**:
    ...
    | Zone de texte **Valeur** | Entrez la chaîne de connexion de compte de stockage que vous avez enregistrée précédemment dans ce labo |
...
1. Dans le volet **Créer une stratégie d’accès**, sélectionnez la section **1 Autorisations** et effectuez les sélections suivantes :
...
1. Sélectionnez la section **2 Principal** et effectuez les sélections suivantes : 
...
1. Sélectionnez **4 Vérifier + créer** et **Créer**.
...
1. Dans l’éditeur de code, passez en revue l’exemple d’implémentation :
...
1. Passez de nouveau en revue le fichier **FileParser.cs**, qui doit maintenant avoir :
...
### Exercice 5 : Nettoyer votre abonnement
