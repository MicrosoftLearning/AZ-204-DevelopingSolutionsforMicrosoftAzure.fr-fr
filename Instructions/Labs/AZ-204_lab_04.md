...
1. Mettez à jour les propriétés **BlobContainerUrl** et **BlobSASToken** en définissant leur valeur sur la propriété **URL** du conteneur d’objets blob Stockage Azure nommé **images** et la valeur du jeton SAS de blob que vous avez enregistrée précédemment dans ce labo.
