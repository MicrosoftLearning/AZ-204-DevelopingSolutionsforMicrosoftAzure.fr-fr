...
1. Si vous avez l’onglet **Paramètres** de l’application dans la section **Configuration**, effectuez les actions suivantes, sélectionnez **Enregistrer**, puis **Continuer**.
   ...
   | Case à cocher **Paramètre d’emplacement de déploiement**          | Conservez la valeur par défaut, puis sélectionnez **OK** pour fermer la boîte de dialogue contextuelle et revenir à la section **Configuration** |
...
1. Si vous n’avez pas d’onglet **Paramètres d’application** dans la section **Configuration**, vérifiez si vous disposez des **variables d’environnement** de lien dans la section **Paramètres**, sélectionnez-la et effectuez les actions suivantes :

   | Setting                                        | Action                                                                                                                  |
   | ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
   | Onglet **Paramètres d’applications**                           |  Select                                                                                                                 |
   | Première zone de texte disponible dans la colonne **Name** |  **StorageConnectionString**                                                                                            |   
   | Zone de texte sur la colonne **Valeur**                | Collez la chaîne de connexion de stockage que vous avez copiée précédemment dans le Bloc-notes                                               |
   | Cliquez sur **Appliquer** en bas                  | Cette opération ouvre la fenêtre contextuelle de confirmation                                                                                  | 
   | Cliquez sur **Confirmer** dans le po-up confirmatioj | Cela permet d’enregistrer la valeur de configuration que vous venez d’entrer |

   Attendez que les paramètres de votre application soient enregistrés avant de poursuivre le labo.

1. Dans le panneau  **App Service** de la section Paramètres, sélectionnez le lien **Propriétés** pour afficher des informations complémentaires sur App Services.
